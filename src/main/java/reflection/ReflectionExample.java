...
public class ReflectionExample {
	public static void main(String[] args) throws NoSuchMethodException, SecurityException {
		...
		try {
			...
			Constructor constructor = rental.getConstructor(int.class);
			...
			// superclasses
			// in that case, superclass of RentCar is the class
			// java.lang.Object
